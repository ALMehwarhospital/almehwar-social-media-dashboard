      ...
      <div className="space-y-10">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div>
            ...
            <h1 className="font-display text-3xl sm:text-4xl text-navy-900 max-w-3xl">{live.isLive ? "Current month source data is live from the Google Sheet." : "Current month data is being shown from the latest cached snapshot."}</h1>
