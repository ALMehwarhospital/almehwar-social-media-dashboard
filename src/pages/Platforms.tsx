...
export default function Platforms(){
  ...
  return <div className="space-y-10">
    <SectionHeader
      ...
      action={<span className={`text-[10px] font-semibold px-2.5 py-1.5 rounded-full ${live.data&&month===live.data.currentMonth&&live.isLive?"bg-mint-100 text-mint-700":"bg-warm-100 text-fog-500"}`}>{live.data&&month===live.data.currentMonth ? (live.isLive ? "LIVE MTD" : "SNAPSHOT MTD") : "CLOSED MONTH"}</span>}
    />
    <Card>
